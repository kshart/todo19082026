...
export type NoteScalarWhereWithAggregatesInput = {
  ...
  uuid?: Prisma.UuidWithAggregatesFilter<"Note"> | string
  title?: Prisma.StringWithAggregatesFilter<"Note"> | string
  todos?: Prisma.JsonWithAggregatesFilter<"Note">
  ...
  updatedUuid?: Prisma.UuidWithAggregatesFilter<"Note"> | string
}

export type NoteCreateInput = {
  uuid?: string
  title: string
  todos: Prisma.JsonNullValueInput | runtime.InputJsonValue
...
export type NoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uuid" | "title" | "todos" | "createdAt" | "updatedAt" | "updatedUuid", ExtArgs["result"]["note"]>
...
export interface NoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const noteWithUuidOnly = await prisma.note.findMany({ select: { uuid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Notes and only return the `uuid`
   * const noteWithUuidOnly = await prisma.note.createManyAndReturn({
   *   select: { uuid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Notes and only return the `uuid`
   * const noteWithUuidOnly = await prisma.note.updateManyAndReturn({
   *   select: { uuid: true },
   *   where: {
   *     // ... provide filter here
   *   },
